    ...
    : Q3MainWindow( parent, name, fl ), clk(clock), rst(rset), mips1(m)
{
	...
	mdi->addWindow(mods);
        ...
        imemview = new MIPSimemview(*mips1.instmem,
			            ...
			            mips1.reg_ID_EX->PC_EX,
			            mips1.reg_ID_EX->valid_EX,
			            mips1.reg_EX_MEM->PC_MEM,
			            mips1.reg_EX_MEM->valid_MEM,
	...
	dmemview->hide();
        ...
        //registers
        regfileview = new MIPSregfileview(*mips1.rbank, mdi);
	regfileview->setCaption( "RegisterBank" );
...
void MIPSctrl::about(void)
{
    QMessageBox::about(this,"About MIPS_SystemC",
         "<b>MIPS_SystemC v1.0</b><br>"
	 "Copyright 2014-2016<br>"
	 "Nuno Lau - Antonio Rui Borges<br>"
	 "Universidade de Aveiro<br>"
	 "nunolau@ua.pt - ruib@det.ua.pt"
	 );
